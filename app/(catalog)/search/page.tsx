...
export function generateMetadata({ searchParams }: { searchParams: Promise<RawCatalogSearchParams> }) { return catalogMetadata({ title: "Search", description: "Cari produk dan brand dalam kurasi IVORY.", pathname: "/search", searchParams, noindex: true }); }
